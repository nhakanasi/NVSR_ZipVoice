...
# ZipVoice⚡ — upstream documentation

This is the README of the upstream project, [k2-fsa/ZipVoice](https://github.com/k2-fsa/ZipVoice), kept here because it
is still the reference for installation, inference and deployment in this
fork. See [README.md](README.md) for what the fork adds.
